...
int sw_lacp_init(struct sw_dev *dev, ......)
{
}

int sw_lacp_start(struct sw_dev *dev)
{
}

int sw_lacp_stop(struct sw_dev *dev)
{
}

int sw_lacp_destroy(struct sw_dev *dev)
{
}

int sw_lacp_frame_handler(struct sw_dev *dev,
		const struct sw_frame *frame, int from_port)
{
}

int sw_lacp_link_change(struct sw_dev *dev, int port, int link_up)
{
}
